...
base_classifiers = [
    ...
    (
        'svm', 
        # dual=False είναι απαραίτητο όταν τα samples > features για να είναι γρήγορο
...
# 3. ΔΙΑΧΩΡΙΣΜΟΣ TRAIN-TEST (65%-35%)
...
# 4. ΔΗΜΙΟΥΡΓΙΑ PIPELINES ΠΡΟΕΤΟΙΜΑΣΙΑΣ (Νέα Λογική για αποφυγή Data Leakage)
...
# 5. ΤΕΛΙΚΟ PIPELINE (PREPROCESSING + STACKING)
...
# Υπολογισμός μέσου όρου και τυπικής απόκλισης για τις καμπύλες
